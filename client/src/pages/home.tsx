        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card p-8 rounded-lg border border-border hover:shadow-lg transition-shadow fade-in" data-testid="card-service-4">
              ...
              <p className="text-muted-foreground">On transforme votre fiche Google My Business en machine à attirer des clients : photos, avis, posts, catégories… tout est optimisé pour vous placer en tête.</p>
            </div>
